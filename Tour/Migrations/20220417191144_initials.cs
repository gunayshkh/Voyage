        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WishListURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BasketURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeaderLayouts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsefulLinks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FooterLayouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FooterLayouts_HeaderLayouts_LogoId",
                        column: x => x.LogoId,
                        principalTable: "HeaderLayouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourServices_SubServices_SubServiceId",
                        column: x => x.SubServiceId,
                        principalTable: "SubServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TourServices_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourServices_SubServiceId",
                table: "TourServices",
                column: "SubServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_TourServices_TripId",
                table: "TourServices",
                column: "TripId");
